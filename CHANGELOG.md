...
### 🐛 Bug Fixes
- **Custom form fields**: Fixed Scan Templates button and Log Viewer buttons not rendering. Uses `addfieldprefix` on fieldsets with short type names instead of full namespace paths.
